...
4. Go to the main blocklet directory `cd blocklets/[main blocklet] or cd website/[main blocklet]`
5. Start development server: `npm run dev`
6. Go to the other website directory `cd blocklets/[other blocklet] or cd website/[main blocklet]`
